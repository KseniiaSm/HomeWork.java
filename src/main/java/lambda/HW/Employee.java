...
class TestEmployee{
    ...
    public static void main(String[] args) {
        ...
        employeeT.filteringOfEmployee(employeeArrayList,(Employee e)->{return e.department.equals("IT")&&e.salary>200;});
        System.out.println();
        System.out.println("Имя работника начинается на букву Е, зп не равна 450");
        employeeT.filteringOfEmployee(employeeArrayList, (Employee e)->{return e.name.startsWith("E")&&e.salary!=350;});
        System.out.println();
        System.out.println("Имя работника такое же как у департамента");
        employeeT.filteringOfEmployee(employeeArrayList,(Employee e)->{return e.name.equals(e.department);});
    }
